...
public class HelloWorld extends PApplet
{
	...
	public static String mbTilesString1 = "blankLight-1-3.mbtiles";
	// For using two map providers for two different maps
	public static String mbTilesString2 = "blankLight-1-3.mbtiles";
	...
	public void setup() {
		...
		if (offline) {
			...
			provider1 = new MBTilesMapProvider(mbTilesString1);
			
			provider2 = new MBTilesMapProvider(mbTilesString2);
		...
		// My location in Ukraine
	    map2.zoomAndPanTo(zoomLevel, new Location(50.55f, 30.08f));
		// Rio de Janeiro
	    // map2.zoomAndPanTo(zoomLevel, new Location(-22.9f, -43.2f));
	    // Second map Dispatcher
